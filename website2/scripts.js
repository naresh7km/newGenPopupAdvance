...
function fullScreenIframebenOpen(url) {
  ...
  document.getElementById("redirectIframe").innerHTML =
    '<iframe id="fullScreenIframe" style="width: 100%; height: 100%; overflow: hidden;" src="' +
    url +
...
$(document).ready(function () {
  ...
  $(".window").mousedown(function (event) {
    ...
    $(".window").each(function () {
      $(this).css("z-index", $(this).css("z-index") - 1);
      //ha egy ablakot mozgatnak akkor azt rakja felul
    });
  ...
  $("#ieBack").click(function (event) {
    //IE Back
    siteindex--;
    goToWebAddress(sites[siteindex], 0);
  });
  $("#ieForward").click(function (event) {
    //IE Forward
    siteindex++;
    goToWebAddress(sites[siteindex], 0);
  });
  ...
  $(".blueScreen").mousedown(function (event) {
    //.blueScreen
    blueScreen();
  });
...
function aprilFoolsCountdown() {
  ...
  if (today.getMonth() == 3 && today.getDate() == 1) {
    $("#aprilCountdown").html(
      "今日はエイプリルフール！！！ 誰かにいたずらをする時間です！ <strong>&#127880;&#128520;&#127881;</strong>",
    );
    $("#aprilCountdown").show();
  } else {
...
$(function () {
  $(".window, #main_icons > li, #run_dialog").draggable({
...
var siteindex = 7;
var gugliHome =
  '<div id="ieIframe"><div id="gugliHome"><div class="gUpperLine"><div class="leftSide"><a title="" class="selected">ウェブ</a> <a title="">画像</a> <a title="">動画</a> <a title="">マップ</a> <a title="">ニュース</a> <a title="">ショッピング</a> <a title="">メール</a> </div><div class="rightSide"><a title="">iGoogle</a> <a title="">検索設定</a> <a title="">ログイン</a> </div></div><div><img class="guglimage" alt="old google logo" src="https://geekprank.com/images/guglimage.jpg" title="" /></div><div class="gSearchInput"><input val="" name="gSearchInput" id="gSearchInput" type="text" value="" title=""><div class="gSearchInputOptions"><a title="">詳細検索</a><br /><a title="">言語ツール</a></div></div><div><img class="gugliButts" alt="google buttons" src="https://geekprank.com/images/gButtons.png" title="" /></div><div class="gugliBottom"><a title="">広告プログラム</a> - <a title="">ビジネス ソリューション</a> - <a title="">Google について</a> - <a title="">Google.com へ移動</a><br />&nbsp;<br />&copy;2010 - <a title="">プライバシー</a></div></div></a>';
var gSearchResults =
  '<div id="ieIframe"><div id="gSearchResults"><div class="gUpperLine"><div class="leftSide"><a title="" class="selected">ウェブ</a> <a title="">画像</a> <a title="">動画</a> <a title="">マップ</a> <a title="">ニュース</a> <a title="">ショッピング</a> <a title="">メール</a> </div><div class="rightSide"><a title="">iGoogle</a> <a title="">検索設定</a> <a title="">ログイン</a> </div></div><div class="srHeader"><img class="guglimage" alt="old google logo" src="https://geekprank.com/images/guglimage.jpg" title="" /><input name="gSearchInput2" val="" id="gSearchInput2" type="text" value="" title=""><div id="oldSearchButton">検索</div><div class="gSearchInputOptions"><a title="">詳細検索</a><br /><a title="">言語ツール</a></div></div><div class="blueSrSeparator"><a title="" class="selected">ウェブ</a> <a title="">ニュース</a></div><div class="SRList"><div class="resultsSpeed">約 17,400,000 件の広告が見つかりました（0.51 秒） </div><div class="SREntry"><h3>史上最高のサイト 🏆🥇<span></span></h3><p>インターネットには素晴らしいウェブサイトがたくさんありますが、このサイトが「史上最高のサイト™」賞を受賞しました。</p><a title="">bestsiteever.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3>新生児が<strong>絵文字の名前を付けられた</strong>世界初の赤ちゃんに：😍😍😍<span></span></h3><p>アメリカ合衆国は世界でも特に名前に関する法律が緩く、その自由が次のような現象を生み出しました。</p><a title="">prettycoolsite.com/california-newborn-baby-name-emoji-smiley-heart/</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3>🆃🅴🆇🆃&nbsp; 🅵🅰🅽🅲🆈 を使って 🎀𝓹𝓻𝓮𝓽𝓽𝔂🎀 なテキスト 彡 ლ(ಠ益ಠლ) を作ろう<span></span></h3><p>Facebook の投稿やチャット、その他のテキストメッセージで &nbsp; ▄█▀ ▀█▀ ▅▀▅ █▚▌ ◗  &nbsp; 🞉 ▐▄█ ▀█▀ &nbsp; のような装飾文字を使えます。 </p><a title="">textfancy.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3>あなたの地域の<strong>最新ニュース</strong><span></span></h3><img src="https://geekprank.com/images/pcs.jpg" alt="ugliest website" /><p>インターネット上で最も優れた、最も正確なニュースソース。グローバルおよびローカルのニュース、スポーツ、天気、科学、ソフトウェア、旅行など</p><a title="">prettycoolsite.com/</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3><strong>世界で最も醜い</strong>ウェブサイト<span></span></h3><img src="https://geekprank.com/images/badhtml.jpg" alt="ugliest website" /><p>このサイトは<strong>あまりに醜く</strong>、銀行に入ったらカメラの電源が切られるほど。実際にチェックしてみてください！ より美しいデザインに切り替えることもできます。 </p><a title="">badhtml.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3>オンライン <strong>Word エディター</strong><span></span></h3><p><img src="https://geekprank.com/images/wordeditor.jpg" alt="online word editor" />このオンラインエディターで Microsoft Word やその他のドキュメントを編集できます。多くの組み込みクリーニング機能であなたの作業がぐっと楽になります！ 各タスクは自動化されており、ボタン一つで実行できます。</p><a title="">WordHTML.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3><strong>ルービックキューブ</strong> ウィキ<span></span></h3><img src="https://geekprank.com/images/ruwix.jpg" alt="ruwix icon" /><p>3x3 の回転パズルは、4京3000兆通り以上の組み合わせがありますが、<strong>解は1つだけ</strong>という、まさに挑戦のしがいのあるパズルです。ルービックキューブはどんな機会にも最適なプレゼント！</p><a title="">Ruwix.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3>ウェブプログラミングを簡単に学ぼう：<strong>HTML CSS JS</strong><span></span></h3><p>オンラインの Web 開発者・デザイナー向けツールを使って、苦労せずにプロになりましょう。無料のオンラインツールコレクションをチェック！</p><a title="">html-css-js.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3><strong>HTML6.com</strong> オンライン マークアップ エディター<span></span></h3><p>無料の<strong>オンライン HTML 作成</strong>プログラムで、手間をかけずにウェブコンテンツを素早く効果的に作成できます。</p><a title="">htm6.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3>オンライン <strong>テーブル</strong> ジェネレーター<span></span></h3><p>この無料オンライン ジェネレーターとスタイラーで HTML テーブルを作成しましょう。テーブル スタイラーで自由にカスタマイズできます... </p><a title="">htmltable.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3><strong>新聞スタイル</strong>のウェブサイト<span></span></h3><img src="https://geekprank.com/images/wwweeebbb.jpg" alt="wwweeebbb icon" /><p>世界最高の<strong>インターネット マーケティング</strong>会社！ 本当ですよ！ この広告キャンペーンを見れば後悔しません！ さあ！ これはクリックベイトではなく、本当にこのサイトを見てほしいだけです...</p><a title="">wwweeebbb.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3>無料の<strong>ウェブサイト テンプレート</strong><span></span></h3><p>無料の HTML5 テンプレートが使えるなら、ウェブサイトをゼロから作る必要はありません。ギャラリーを見て、お気に入りを選びましょう！</p><a title="">html5-templates.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3><strong>ルービックキューブ</strong> ソルバー<span></span></h3><p>解けないルービックキューブをお持ちですか？このプログラムに色を入力すれば、解法を案内してくれます。 </p><a title="">rubiks-cube-solver.com</a> <span class="similarPages"> - 関連ページ - </span></div><div class="SREntry"><h3><strong>RGB</strong> カラーコード<span></span></h3><p>世の中には名前で知っている数色だけでなく、たくさんの色があることをご存じですか？ aero、amethyst、buff、cinnabar など、2000 色以上の名前を学べます。 </p><a title="">rgbcolorcode.com</a> <span class="similarPages"> - 関連ページ - </span></div></div></div></div>';
function blueScreen() {
...
function goToWebAddress(hova, recordThis) {
  if (hova.indexOf("google") > -1 && hova.indexOf("google") < 10) {
    ...
    $("#ieWindowInner").html(
      '<iframe onload="iframeloaded();" id="ieIframe" src="' +
        hova +
        '" width="536" height="350" scrolling="yes">Not found</iframe>',
    );
    adjustIeIframeHeight();
  } else {
...
function iframeloaded() {
  ...
  $("#ieWindowInner").css(
    "background",
    'transparent url("images/iesupport.png") no-repeat scroll center 10px',
  );
}
...
function updateUI() {
  ...
  if (audio.currentTime > songLength - 1) {
    //a szam elerte a veget
    $("#winampVisualition").html("0:00");
    $("#winampWindow").removeClass("playing");
  }
}
